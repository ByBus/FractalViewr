...
class GradientRepository {
    ...
    init {
        with(gradients) {
            addAll(
                listOf(
                    "Gradient 1" to listOf(-63488, -8192, -16318720, -16712193, -16252673, -589569, -65536),
                    "Gradient 2" to listOf(-16751718, -3529381, -16751718, -3878, -16751718, -3878, -16751718, -3529381, -3878, -16751718, -3529381, -3878),
